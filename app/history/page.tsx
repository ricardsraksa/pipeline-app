...
function StatusPill({ status, stuck }: { status: string | null; stuck?: boolean }) {
  ...
  const tones: Record<Tone, string> = {
    active:  "bg-[color:rgb(79_139_255_/_0.12)]  text-[var(--color-accent)]  border-[color:rgb(79_139_255_/_0.30)]",
    success: "bg-[color:rgb(74_222_128_/_0.10)]  text-[var(--color-success)] border-[color:rgb(74_222_128_/_0.25)]",
    warn:    "bg-[color:rgb(251_191_36_/_0.10)]  text-[var(--color-warn)]    border-[color:rgb(251_191_36_/_0.25)]",
    danger:  "bg-[color:rgb(248_113_113_/_0.10)] text-[var(--color-error)]   border-[color:rgb(248_113_113_/_0.25)]",
              ...
              return (
                <Link
                  ...
                  className={[
                    ...
                    isActive
                      ? "bg-[color:rgb(79_139_255_/_0.04)] hover:bg-[color:rgb(79_139_255_/_0.08)]"
