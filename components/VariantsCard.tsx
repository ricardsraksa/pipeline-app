...
// The variants to set up in Shopify: every option group with its values, and
// each SKU with its supplier price and the price the rules give it. Read from
// the AliExpress listing, then restructurable — by hand or with an instruction
// like "split into Color and Size", since suppliers cram several dimensions
// into one group. Display only; nothing here is pushed to Shopify.
...
export default function VariantsCard({ runId, scrape, rules, band = null, requestedAt = null, edited = null }: {
  runId: number;
  scrape: string | null;
  rules?: PricingRules;
